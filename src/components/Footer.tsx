      ...
      <div className="container mx-auto px-6 py-12">
        <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-center md:text-left mb-6 md:mb-0">
                <h3 className="text-2xl font-bold text-white font-grotesk">{content.header.logo}</h3>
          ...
          <div className="flex justify-center space-x-6">
            {content.footer.socialLinks.map((social) => (
              <a key={social.name} href={social.href} className="text-warm-gray-400 hover:text-white transition-colors">
