    ...
    <section id="pricing" className="py-20 bg-warm-gray-900">
      <div className="container mx-auto px-6">
        ...
        <p className="text-center text-warm-gray-400 mt-8">
            {content.pricing.enterpriseCta.split('Contact us')[0]} 
            <a href="#cta" className="text-teal font-semibold hover:underline">Contact us</a>
            {content.pricing.enterpriseCta.split('Contact us')[1]}
        </p>
      </div>
    </section>
  );
